...
class AddAddressFragment : Fragment() {
    ...
    private fun addAddress(addressName: String, addressStreet: String, addressNumber: String,addressZipCode: String, addressCityName: String) {
        ...
        mMainActivityViewModel.address_title.add(addressName)
        mMainActivityViewModel.address_street.add(addressStreet)
        mMainActivityViewModel.address_house_number.add(addressNumber)
        mMainActivityViewModel.address_post_code.add(addressZipCode)
        mMainActivityViewModel.address_city_name.add(addressCityName)
