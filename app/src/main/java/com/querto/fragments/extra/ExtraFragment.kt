package com.querto.fragments.extra
...
class ExtraFragment(val activity: MainActivity,val  item: CartItem) : Fragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
      ...
      var extraSosyAdapter=  ExtraSosyAdapter(activity,mMainActivityViewModel.sosy_names, mMainActivityViewModel.sosy_price,item, view.podsumowanie_text)
      var extraDodatkiAdapter = ExtraDodatkiAdapter(activity, mMainActivityViewModel.dodatki_names, mMainActivityViewModel.dodatki_small_price, mMainActivityViewModel.dodatki_medium_price, mMainActivityViewModel.dodatki_big_price , item, view.podsumowanie_text)
      ...
      activity.updateSummary(view.podsumowanie_text, item)
        return view
    }
